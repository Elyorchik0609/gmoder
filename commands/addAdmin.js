...
const memberIsAddedAdmin = require('../middlewares/memberIsAddedAdmin');

bot.hears('!addmin', chatIsGroup, botIsAdmin, userIsMember, memberIsAddedAdmin, memberIsAdmin, memberIsAdmin, adminIsSuper, ctx => {
