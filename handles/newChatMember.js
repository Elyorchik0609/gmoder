...
bot.on('new_chat_members', botIsAdmin, ctx => {
  ...
  const msg = `Guruhda yangi a'zo!\n\nHurmatli <b><a href="tg://user?id=${userid}">${firstname + ' ' + lastname}</a></b> guruhimizga Hush kelibsiz!\nGuruhimiz <a href="https://t.me/TGraph_Rules">qoida</a>lari bilan albatta tanishib chiqing!\nTanishib chiqganingizdan so'ng qoidalarga rozi ekanligingizni bildiring`;
